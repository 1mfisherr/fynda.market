...
const newsletter: Record<Locale, FormPage> = {
  de: {
    ...
    description: 'Jeden Freitag: was am Wochenende in Ihrer Nähe läuft, plus eine kurze Nachricht, wenn ein Markt abgesagt wird. Kostenlos, kein Konto nötig.',
    heading: 'Newsletter',
    answer: 'Jeden Freitagmorgen eine E-Mail: was am Wochenende in Ihrer Stadt los ist.',
    prose: [
      'Einmal pro Woche, am Freitag, für eine Stadt, einen Kanton oder das ganze Land: die Märkte am Wochenende, die neuen Termine, die abgesagten. Sagt ein Veranstalter danach einen Termin ab, bekommen Sie noch am selben Tag eine kurze Nachricht — damit Sie nicht umsonst hinfahren.',
      'Kostenlos, kein Konto nötig. Ein Klick in jeder E-Mail, und Sie sind von der Liste.',
    ],
    fields: [
    ...
    submit: 'Anmelden',
    note: 'Nur dieser Newsletter, sonst nichts, und Ihre Adresse wird nie weitergegeben.',
    subject: 'Newsletter',
  ...
  fr: {
    ...
    submit: "S'inscrire",
    note: "Cette newsletter seulement, rien d'autre, et votre adresse n'est jamais transmise.",
    subject: 'Newsletter',
  ...
  it: {
    title: 'Newsletter — fynda.market',
    description: 'Ogni venerdì: cosa c’è questo fine settimana vicino a Lei, più un avviso se un mercatino viene annullato. Gratis, senza account.',
    heading: 'Newsletter',
    answer: 'Ogni venerdì mattina una e-mail: cosa succede questo fine settimana nella Sua zona.',
    prose: [
      'Una volta alla settimana, il venerdì, per una città, un cantone o tutto il paese: i mercatini del fine settimana, le nuove date, quelle annullate. Se poi un organizzatore annulla una data, riceve un breve avviso lo stesso giorno — così non fa il viaggio per niente.',
      'Gratis, senza account. Un clic in qualsiasi e-mail, ed è fuori dalla lista.',
    ],
    fields: [
    ...
    submit: 'Iscriversi',
    note: 'Solo questa newsletter, nient’altro, e il Suo indirizzo non viene mai passato a nessuno.',
    subject: 'Newsletter',
  ...
  en: {
    ...
    submit: 'Sign up',
    note: 'Only this newsletter, nothing else, and your address is never passed on.',
    subject: 'Newsletter',
...
const organiser: Record<Locale, FormPage> = {
  ...
  it: {
    ...
    heading: 'Il Suo mercatino è probabilmente già in elenco.',
    answer: 'Lo prenda in mano, e la pagina è Sua — gratis, senza account.',
    prose: [
      'fynda.market elenca i mercatini a partire dai siti e dai calendari degli organizzatori, che ci abbiano contattato o no. Il Suo mercatino ha quindi molto probabilmente già una pagina, con date, indirizzo e orari. Prenderla in mano significa decidere cosa dice.',
    ],
    ...
    list: [
      ...
      "Ogni data che conferma riporta «Confermato dall'organizzatore» e il giorno in cui l'ha fatto.",
      "Un annullamento compare sulla pagina entro un'ora, e chi ha la newsletter per la Sua zona lo sa subito.",
    ],
    after: 'Domande? Scriva a contact@fynda.market.',
    fields: [
    ...
    note: 'Delfim legge ogni richiesta di persona. Il Suo link personale arriva via e-mail, di solito entro un giorno.',
    subject: 'Organizzatore',
    success: 'Grazie — la Sua richiesta è arrivata. Il Suo link personale arriva via e-mail, di solito entro un giorno.',
    failure: 'Non ha funzionato. Apriamo il Suo programma di posta — ci mandi semplicemente il messaggio.',
    errors: {
      invalid: 'Questo indirizzo e-mail non sembra corretto. Lo controlli ancora una volta.',
      failed: 'Non ha funzionato. Riprovi, per favore.',
