...
const newsletter: Record<Locale, FormPage> = {
  de: {
    ...
    submit: 'Anmelden',
    note: 'Nur dieser Newsletter, sonst nichts, und deine Adresse wird nie weitergegeben.',
    subject: 'Newsletter',
  ...
  it: {
    ...
    submit: 'Iscriversi',
    note: 'Solo questa newsletter, nient’altro, e il tuo indirizzo non viene mai passato a nessuno.',
    subject: 'Newsletter',
