    ...
    blocks: [
      ...
      },
      {
        ...
        ul: [
          ...
          'Telegram (Telegram Messenger Inc., Dubai) tells Delfim when a form arrives: which form, the market, the organiser\'s name on a claim and only the domain of an e-mail address, never the address itself.',
    ...
    blocks: [
      ...
      },
      {
        ...
        ul: [
          ...
          'Telegram (Telegram Messenger Inc., Dubai) meldet Delfim, wenn ein Formular eintrifft: welches Formular, der Markt, bei einer Übernahme der Name des Veranstalters und von einer E-Mail-Adresse nur die Domain, nie die Adresse selbst.',
    ...
    blocks: [
      ...
      },
      {
        ...
        ul: [
          ...
          "Telegram (Telegram Messenger Inc., Dubaï) prévient Delfim quand un formulaire arrive : lequel, le marché, le nom de l'organisateur pour une demande de reprise et, d'une adresse e-mail, seulement le domaine, jamais l'adresse elle-même.",
    ...
    blocks: [
      ...
      },
      {
        ...
        ul: [
          ...
          "Telegram (Telegram Messenger Inc., Dubai) avvisa Delfim quando arriva un modulo: quale modulo, il mercatino, il nome dell'organizzatore per una richiesta e, di un indirizzo e-mail, solo il dominio, mai l'indirizzo stesso.",
