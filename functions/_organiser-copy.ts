...
export const COPY: Record<Locale, OrganiserCopy> = {
  de: {
    ...
    whyCount: 'Diese Seite sehen die Leute, wenn sie ihn suchen — die Termine, die Öffnungszeiten, ob er stattfindet. %n haben sie im letzten Monat angeschaut. Besucher vertrauen einem Termin, den Sie bestätigt haben, viel mehr als einem, den ich von Ihrer Website abgeschrieben habe, und mehr von ihnen kommen, wenn sie das sehen.',
    why: 'Diese Seite sehen die Leute, wenn sie ihn suchen — die Termine, die Öffnungszeiten, ob er stattfindet. Besucher vertrauen einem Termin, den Sie bestätigt haben, viel mehr als einem, den ich von Ihrer Website abgeschrieben habe, und mehr von ihnen kommen, wenn sie das sehen.',
    ...
    nextHint: 'Ein Tipp, und die Seite sagt, dass Sie es heute bestätigt haben. Das ist die Zeile, der die Leute vertrauen.',
  ...
  fr: {
    ...
    whyCount: "Cette page est ce que les gens voient quand ils le cherchent — les dates, les horaires, s'il a lieu. %n l'ont regardée le mois dernier. Les visiteurs font bien plus confiance à une date que vous avez confirmée qu'à une date que j'ai recopiée de votre site, et ils sont plus nombreux à venir quand ils le voient.",
    why: "Cette page est ce que les gens voient quand ils le cherchent — les dates, les horaires, s'il a lieu. Les visiteurs font bien plus confiance à une date que vous avez confirmée qu'à une date que j'ai recopiée de votre site, et ils sont plus nombreux à venir quand ils le voient.",
    ...
    nextHint: "Un clic, et la page dit que vous l'avez confirmé aujourd'hui. C'est la ligne à laquelle les gens font confiance.",
    ...
    allRight: 'Elles sont toutes justes',
  ...
  it: {
    ...
    whyCount: "Questa pagina è quello che la gente vede quando lo cerca — le date, gli orari, se si fa. %n l'hanno guardata il mese scorso. I visitatori si fidano molto di più di una data che hai confermato tu che di una che ho copiato dal tuo sito, e in più decidono di venire quando lo vedono.",
    why: "Questa pagina è quello che la gente vede quando lo cerca — le date, gli orari, se si fa. I visitatori si fidano molto di più di una data che hai confermato tu che di una che ho copiato dal tuo sito, e in più decidono di venire quando lo vedono.",
    ...
    nextHint: "Un tocco, e la pagina dice che l'hai confermato oggi. È la riga di cui la gente si fida.",
  ...
  en: {
    ...
    whyCount: "This page is what people see when they look for it — the dates, the hours, whether it's on. %n of them looked at it last month. Visitors trust a date you've confirmed far more than one I copied from your website, and more of them come when they see you have.",
    why: "This page is what people see when they look for it — the dates, the hours, whether it's on. Visitors trust a date you've confirmed far more than one I copied from your website, and more of them come when they see you have.",
    ...
    nextHint: "One tap and the page says you confirmed it today. That's the line people trust.",
