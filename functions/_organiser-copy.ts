...
export const COPY: Record<Locale, OrganiserCopy> = {
  de: {
    ...
    hello: 'Hallo, und danke für das, was Sie tun.',
    whyCount: 'Ein Markt wie Ihrer ist der Grund, warum Leute aus dem Haus gehen. %n von ihnen haben diese Seite im letzten Monat angeschaut. Halten Sie sie aktuell, und sie kommen wieder.',
    why: 'Ein Markt wie Ihrer ist der Grund, warum Leute aus dem Haus gehen. Halten Sie diese Seite aktuell, und sie finden ihn.',
  ...
  fr: {
    ...
    hello: 'Bonjour, et merci pour ce que vous faites.',
    whyCount: "Un marché comme le vôtre, c'est ce qui fait sortir les gens de chez eux. %n d'entre eux ont regardé cette page le mois dernier. Gardez-la à jour et ils reviendront.",
    why: "Un marché comme le vôtre, c'est ce qui fait sortir les gens de chez eux. Gardez cette page à jour et ils le trouveront.",
  ...
  it: {
    ...
    hello: 'Ciao, e grazie per quello che fai.',
    whyCount: 'Un mercatino come il tuo è il motivo per cui la gente esce di casa. %n di loro hanno guardato questa pagina il mese scorso. Tienila aggiornata e torneranno.',
    why: 'Un mercatino come il tuo è il motivo per cui la gente esce di casa. Tieni questa pagina aggiornata e lo troveranno.',
  ...
  en: {
    ...
    hello: 'Hello, and thanks for what you do.',
    whyCount: "A market like yours is why people get out of the house. %n of them looked at this page last month. Keep it up to date and they'll keep coming.",
    why: "A market like yours is why people get out of the house. Keep this page up to date and they'll find it.",
