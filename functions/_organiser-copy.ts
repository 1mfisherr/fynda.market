...
export const COPY: Record<Locale, OrganiserCopy> = {
  de: {
    ...
    confirmBody: 'Ein Klick, und Ihre Seite zeigt es innerhalb einer Stunde.',
    ...
    cancelledBody: '%m am %d steht innerhalb einer Stunde als abgesagt auf Ihrer Seite. Wer den Termin im Newsletter abonniert hat, erfährt es jetzt.',
