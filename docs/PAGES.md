...
| Opening | *Hello, and thanks for what you do.* / *A market like yours is why people get out of the house. **412 of them** looked at this page last month. Keep it up to date and they'll keep coming.* — the count is real (`market_people_30d`, people not crawlers) and appears only from 20 up; below that the line has no number |
