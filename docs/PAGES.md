...
| Opening | *Thank you for running a market.* / *This page is what people see when they look for it — the dates, the hours, whether it's on. **412 of them** looked at it last month. Visitors trust a date you've confirmed far more than one I copied from your website, and more of them come when they see you have.* — the count is real (`market_people_30d`, people not crawlers) and appears only from 20 up; below that the line has no number |
