...
A Cloudflare Function, not a static page (`functions/a/[[path]].ts`, copy in `functions/_organiser-copy.ts`); in the organiser's own language; `noindex`. Built 2026-09-21 from the content and copy below, Delfim's words: **"the more organisers use it the better the product — this should be our north star."** One 720px column on every width; controls as `BRAND.md` §Controls.

**The voice is Delfim writing to a person**, in full sentences: why their answer matters to visitors, then what they can do. Rejected 2026-09-21: clipped lines ("one tap, no account"), walkthroughs of what the system does, "we're building", metaphors, and any weekday that is not a real date. The welcome mail (`functions/_mail.ts`) is the same letter.

Top to bottom, English master (the other three follow it):

| Block | Copy |
|---|---|
| Head | eyebrow *Your market's page* · name · town and rhythm · *See your page as visitors see it ↗* (the public page, new tab) · the photo as visitors see it |
| Opening | *Thank you for running a market.* / *I'm Delfim, and this is your market's page on fynda.market, where people nearby look for the next one. What they find here — your dates, your hours, whether it's on — is what decides if they come. **412 of them** looked last month. When a date carries your word, people trust it and turn up. That's all this page asks of you: a look, and a tap.* — organisers don't know the site, so the page says who is writing before it asks anything (Delfim, 2026-09-22: "copied from your website" was rejected as a machine apologising). The count is real (`market_people_30d`, people not crawlers) and appears only from 20 up |
| Next date | *Your next date. Is it still on?* · the date in accent, times, venue · *We last checked this on 19 September.* · two choices side by side, **Yes, it's on** / **Something's changed** — nothing is written on tap · *Confirm at the bottom, after a look at the rest.* Delfim pressed the earlier one-tap button before reading the page (2026-09-22); the answer now travels with the edits to the one button at the foot |
| Your dates | *Here's everything we have for you. Change what's wrong, add what's missing. If you cancel a date, everyone nearby who signed up for news hears the same day.* · a list: date, times, stamp (*Confirmed 19 Sep* / *Not yet confirmed*), *Cancel* (asks once — it mails subscribers) · *Add a date* (one row at a time) |
| About the market | *A few things people ask before they come. Fill in what you know and skip the rest.* · **Roughly how many stalls** · **Indoors or out** (Indoors / Outdoors / Both) · **If it rains** (Goes ahead / Cancelled / We decide that morning — hint *"We decide that morning" is fine. People just want to know to check first.*) · **Entry for visitors** · **Your website** · **Where people book a stall** (hint *The question we get asked most. Better they ask you.*) · **Getting there** (placeholder *Bus stop, parking, whatever you tell your own friends*) · **What people find here** — tag chips, hint *Pick a few. It's how someone looking for old records finds you.* · **In your words** — free text in their language, hint *We show them as yours, and we don't touch them.* · **A photo** — *Got one? Reply to our mail with it. It goes up the same week. A phone photo on a busy morning is perfect.* · **[Confirm]** the one filled button, accent, under it *On your page within the hour.* — it writes the answer to the question at the top and every edit together, then returns to the page with a block above the title: *Confirmed. Thank you. It's on your page within the hour.* "Yes" stamps the next date as confirmed by the organiser today; "Something's changed" is counted and answered by the edits; no choice is an edit, not an answer |
