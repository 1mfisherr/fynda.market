...
2. **Analytics v2** — built 2026-09-17 (`reference/analytics-research/build-plan.md` phases 1–3). Left: an edge-time `suspect` flag to feed the bot view, partitioning. The key-forgetting job is dropped — all data stays as is (Delfim, 2026-09-19). Before Germany: Queues, Supabase Pro, R2. No GA4, no Clarity. Read the Engagement dashboard after a week of data.
