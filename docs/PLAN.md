...
0. **Organiser edit page — deep overhaul.** Delfim opened a real one (Carouge, 2026-09-20) and rejected it: "looks like shit". Not a polish — redesign it against `BRAND.md` like every visitor page got on 2026-09-17, then drive it live at 375 and 1440 with a real link. **Gates step 1: no welcome mail goes out before this page is done** (Delfim, 2026-09-20). What it holds: dates with the three answers, stall count, indoor/outdoor, rain policy, photo upload not yet.
