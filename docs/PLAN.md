...
0. **Organiser edit page — deep overhaul.** Delfim opened a real one (Carouge, 2026-09-20) and rejected it: "looks like shit". Not a polish — redesign it against `BRAND.md` like every visitor page got on 2026-09-17, then drive it live at 375 and 1440 with a real link. **Gates step 1: no welcome mail goes out before this page is done** (Delfim, 2026-09-20). Content and copy approved 2026-09-21 from a mockup (Carouge, phone and desktop): the market as visitors see it with last month's real view count; "your next date, still right?" as one tap; dates as a list with a stamp, Change and Cancel; stalls, indoor/outdoor, rain, entry, website, where to book a stall, getting there, tags, "in your words"; photo by mail reply for now. The tone is a vision, not a walkthrough — Delfim rejected "explaining steps". The opening lines (view count, "this page is where you say it") are also the shape of the welcome mail. The look comes next.
